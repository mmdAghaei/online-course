...
import 'package:podcast/feature/panel%20admin/news/add/add-news-screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Get.to(AddNewsScreen(), arguments: {"title": "اضافه کردن"});
        },
                  ...
                  children: newsApiController.newsList.map((index) {
                    return InkWell(
                      onTap: () {
                        ...
                        Get.to(
                          AddNewsScreen(),
                          arguments: {"title": "ویرایش", "data": index},
                        );
                      },
                      child: Container(
